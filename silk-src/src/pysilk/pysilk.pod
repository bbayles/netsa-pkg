...
PSH, ACK, URG, ECE, and CWR flags.  As of SiLK 3.20.0, the constructor
accepts C<-> which sets all flags in the contructor.  Spaces in the
string are ignored.
...
$SiLK: pysilk.pod 35b901fd2f56 2023-03-10 19:46:07Z mthomas $
