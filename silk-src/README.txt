...
released under a GNU General Public License 2.0-style license and with
Government Purpose Rights.  See more information below.
...
https://tools.netsa.cert.org/silk/silk-install-handbook.html or
https://tools.netsa.cert.org/silk/silk-install-handbook.pdf
...
the doc/ directory:
    ...
    LICENSE.txt
        -- complete description of SiLK's copyright, license, and no
           warranty disclaimer
